...
namespace DevHopsGh
{
    public class DevHopsGhComponent : GH_Component
    {
        ...
        public DevHopsGhComponent()
          : base("DevHopsGh", "DevHops",
            "Integration of Grasshopper scripts with Kanban board",
            "DevHops", "")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("7F2B8DB7-EC50-4564-A210-B5DCBE5651F3");
    }
}